...
public class ModelQuint4UPSEntity extends ModelBaseEntity {
	...
	private double Battery1StatusofFuse;
	...
	public double getBattery1StatusofFuse() {
		return Battery1StatusofFuse;
	}
	public void setBattery1StatusofFuse(double battery1StatusofFuse) {
		Battery1StatusofFuse = battery1StatusofFuse;
	}
