...
public class NoCommunicationAlertEvent extends ApplicationEvent {

	private static final long serialVersionUID = 2385571491438533570L;
	private DeviceEntity device;
	private ModelBaseEntity data;

	public NoCommunicationAlertEvent(Object source, DeviceEntity device, ModelBaseEntity data) {
		super(source);
		this.device = device;
		this.data = data;
	}
